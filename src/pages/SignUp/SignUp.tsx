        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="inputForm">
            ...
            <div className="flex justify-between">
              <input required type="text" name="nickName" id="nickName" placeholder="한글, 영문, 숫자 가능 3~10자" className={`shortInput ${nickNameInput()}`} onChange={nickName.onChange} value={nickName.data} />
