...
const noticeList: listInfo[] = [
  {
    ...
    date: new Date(),
    data: '안녕하세요. 동행입니다. 보다 나은 서비스를 제공하기 위해 사이트 안정화 및 서버 점검 작업을 진행하게 되어 안내해 드립니다. 작업 일시 : 2023년 01월 12일(목) 05:00 ~ 07:00 (2시간) 작업 내용 : 동행 서버 점검 작업 영향 : 동행 사이트 이용제한 * 점검시간은 공지보다 다소 길어질 수 있습니다. 서비스 이용에 불편을 끼쳐 대단히 죄송합니다. 더욱 편리하고 안정적인 서비스를 제공해 드리기 위해 최선을 다하는 동행이 되겠습니다. 감사합니다. 더욱 편리하고 안정적인 서비스를 제공해 드리기 위해 최선을 다하는 동행이 되겠습니다. 감사합니다. 더욱 편리하고 안정적인 서비스를 제공해 드리기 위해 최선을 다하는 동행이 되겠습니다. 감사합니다.',
  },
  {
